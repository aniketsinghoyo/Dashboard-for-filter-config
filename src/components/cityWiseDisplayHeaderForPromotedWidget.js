...
export default class CityWise extends React.Component {
    constructor(props) {
        super(props);
        this.state={
            key:this.props.keys,
                            ...
                            <div>

                                {
                                    this.generateData(tile[key]).map(keys=>
                                        <pre><b>{keys} : {tile[key][keys]} </b> <button onClick={this.delete.bind(this,keys)}>Delete</button></pre>
                                    )
                                }
                                    ...
                                    <AccordionDetails>
                                        <form onSubmit={this.handleSubmit1}>
                                            <label>
                                                ...
                                                <input type="text" name="" style={{'width':'70px','height':'20px'}} value={this.state.name} onChange={this.handleChange1} />&nbsp;
                                               :
