...
export default class EnableAme extends React.Component {
    constructor(props) {
        super(props);
        this.state={
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        <Typography>
                            <div>
                                {
                                  <pre><b><input type="text" name="" style={{'width':'70px','height':'20px'}} value={this.state.tile[key]} onChange={(event)=>this.handleChange(event,key)}/></b></pre>
                                }
                            </div>
