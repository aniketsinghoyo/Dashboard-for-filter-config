                        ...
                        <AccordionDetails>
                            <form onSubmit={this.handleSubmit1}>
                                <label>
                                    ...
                                    <br/>value <br/><br/>
                                    <input type="text" name="" style={{'width':'170px','height':'20px'}} value={this.state.val1} onChange={this.handleChange2} /> :&nbsp;
                                    <input type="text" name="" style={{'width':'170px','height':'20px'}} value={this.state.val2} onChange={this.handleChange3} />
                                </label>
                                <br/><br/>
                                <input type="submit" value="Post" />
                            </form>
